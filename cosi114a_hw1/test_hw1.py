...
class TestCounts(unittest.TestCase):
    ...
    def test_count_unigrams(self) -> None:
        """Basic unigram counts are correct."""
        ngrams = count_unigrams(
            gen_sentences(os.path.join("test_data", "hw1_tokenized_text_3.txt")), True
        )
        self.assertEqual(10, ngrams["the"])
    ...
    def test_count_bigrams_lower(self) -> None:
        """Bigram counts are correct with lowercasing"""
        ngrams = count_bigrams(
            gen_sentences(os.path.join("test_data", "hw1_tokenized_text_3.txt")), True
        )
        self.assertEqual(3, ngrams[("the", "cat")])
