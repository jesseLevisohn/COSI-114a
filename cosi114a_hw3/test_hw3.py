...
class TestScoringMetrics(unittest.TestCase):
    ...
    @points(0)
    def test_precision_divide_by_zero(self):
        """Precision is zero when the denominator is zero"""
        predicted = ["F", "F", "F", "F", "F", "F", "F", "F", "F", "F"]
        actual = ["T", "T", "T", "T", "T", "F", "F", "F", "F", "F"]
        self.assertAlmostEqual(0, precision(predicted, actual, "T"))
    ...
    @points(0)
    def test_recall_divide_by_zero(self):
        """Precision is zero when the denominator is zero"""
        actual = ["F", "F", "F", "F", "F", "F", "F", "F", "F", "F"]
        predicted = ["T", "T", "T", "T", "T", "F", "F", "F", "F", "F"]
        self.assertAlmostEqual(0, precision(predicted, actual, "T"))
    ...
    @points(0)
    def test_f_1_divide_by_zero(self):
        """F1 is zero when there would be a divide by zero error"""
        actual = ["F", "F", "F", "F", "F", "F", "F", "F", "F", "F"]
        predicted = ["F", "F", "F", "F", "F", "F", "F", "F", "F", "F"]
        self.assertAlmostEqual(0, f1(predicted, actual, "T"))
